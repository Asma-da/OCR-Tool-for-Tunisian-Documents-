...
This project aims to automate the processing of Tunisian administrative documents by combining OCR, data validation, and authenticity verification in a single platform.
...
No cloud dependency — all processing is done locally to ensure data privacy.
...
Export extracted data and verification results to:
...
OCR Engines (e.g., Tesseract / custom pipelines)
...
This project was developed as part of an academic initiative focusing on:

Intelligent document processing

Secure data handling

Practical OCR applications for public administration

👤 Author

Asma
Engineering Student – Intelligent Systems & AI

📜 License

This project is intended for academic and educational use.
Licensing can be added based on deployment requirements.
